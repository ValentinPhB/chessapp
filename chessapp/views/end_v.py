...
class EndScreenView:
    ...
    def show_ranking_tournament(player_tournament_sorted):
        print("-----------------------------------------------------------------------------------------")
        print("\n\nLE NOMBRE DE ROUNDS POUR CE TOURNOI À ÉTÉ ATTEINT ET LES RÉSULTATS DES PRÉCÉDENTS"
              " MATCHS ONT ÉTÉ ASSIGNÉS.")
    ...
    # AUTO ADD END DATE TOURNAMENT.
    @staticmethod
    def add_date_tournament():
        print("\n> INFORMATION : La date de fin du tournoi a automatiquement été ajoutée.\n")
