...
class MenuView:
    """
    All views for HomeMenuController, AddPlayerMenuController, PlayerDataMenuController, ContinueMenuController,
    RoundMakingMenuController, SuggestRankingMenuController and UpdateRankingMenuController.
    """
    ...
    @staticmethod
    def no_players_db():
        print("\n> INFORMATION : Il n'y a actuellement aucun joueur dans la base de données que vous pourriez ajouter.")
